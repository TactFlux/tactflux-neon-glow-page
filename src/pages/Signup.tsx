...
const Signup = () => {
  ...
  return <div className="min-h-screen bg-tactflux-dark flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="glass-card border border-white/10 p-8 rounded-xl w-full max-w-md backdrop-blur-md bg-black/40 relative z-10 shadow-card">
        <div className="mb-6 flex justify-center my-0">
          <TactFluxLogo />
        </div>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
            ...
            field
                  ...
                  <FormControl>
                    <div className="relative">
                      <Input placeholder="ihre.email@beispiel.de" {...field} className="bg-white/10 border-white/20 text-white focus-visible:ring-tactflux-blue" />
            ...
            field
                  ...
                  <FormControl>
                    <div className="relative">
                      <Input type={showPassword ? "text" : "password"} placeholder="Passwort eingeben" {...field} className="bg-white/10 border-white/20 text-white focus-visible:ring-tactflux-blue" />
                      <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-3 top-2.5 text-tactflux-blue">
            ...
            field
                  ...
                  <FormControl>
                    <div className="relative">
                      <Input type={showConfirmPassword ? "text" : "password"} placeholder="Passwort wiederholen" {...field} className="bg-white/10 border-white/20 text-white focus-visible:ring-tactflux-blue" />
                      <button type="button" onClick={() => setShowConfirmPassword(!showConfirmPassword)} className="absolute right-3 top-2.5 text-tactflux-blue">
            ...
            <Button type="submit" variant="tactflux-gradient" className="w-full font-medium mt-6 rounded-full">
              Registrieren
            </Button>
          </form>
        </Form>
